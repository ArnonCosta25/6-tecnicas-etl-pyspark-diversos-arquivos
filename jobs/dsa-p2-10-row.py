...
print("Imprime os valores da Row, acessando-os por índice")
...
print("Imprime o valor do campo 'nome' da segunda Row")
print(row2.nome)
print()  
...
print("Imprime os nomes das duas instâncias de Person")
...
print("Imprime os dados coletados")
print(collData)
print() 

# Itera sobre cada Row no conjunto de dados coletados
print("Itera sobre cada Row no conjunto de dados coletados")
for row in collData:
...
# Imprime os dados coletados
print("Imprime os dados coletados da lista person")
print(collData)
print()  

# Itera sobre cada instância de Person no conjunto de dados coletados
print("Itera sobre cada instância de Person no conjunto de dados coletados")
