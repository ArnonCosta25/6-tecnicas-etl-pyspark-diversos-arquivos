...
print(df.select(approx_count_distinct("salario")).collect())
print(df.select(approx_count_distinct("salario")).collect()[0])
print(df.select(approx_count_distinct("salario")).collect()[0][0])
